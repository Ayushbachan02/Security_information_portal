...
<body>
    ...
    <div class="container-fluid row">
        ...
        <div class="bg-light col-auto col-md-4 col-lg-2 min-vh-100">
            <div class="bg-light p-2">
                ...
                <ul class="nav nav-tabs flex-column mt-3">
                    ...
                    <li class="nav-item mt-1">
                        <a href="feedback.php" class="nav-link text-black rounded-2 active">
        ...
        <form action="" method="post" id="complain">
                        ...
                        <div class="form-group mb-3">
                            <input type="number" name="password" class="form-control form-control-lg gb-light fs-6" placeholder="Your Number">
                        </div>
                        <div class="form-group mb-3">
                            <textarea style="height: 120px;" name="cpassword" class="form-control form-control-lg gb-light fs-6" placeholder="Feeback"></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <button type="submit" name="submit" class="btn brn-lg btn-primary w-100 fs-6">Submit Feedback</button>
